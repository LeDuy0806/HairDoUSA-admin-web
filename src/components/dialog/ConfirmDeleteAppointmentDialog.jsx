import {useDeleteAppointmentMutation} from '@/services/appointment';
...
const ConfirmDeleteAppointmentDialog = ({id, onSuccess}) => {
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            appointment and remove the data from the system.
          </DialogDescription>
        </DialogHeader>
...
export default ConfirmDeleteAppointmentDialog;
